...
model = AutoModelForCausalLM.from_pretrained(training_run_args.base_model, trust_remote_code=True, torch_dtype=torch.bfloat16)
...
if training_run_args.use_lora:
    ...
    training_callbacks.append(SavePeftModelCallback)
